...
- 📘 [Manual de Usuario](./docs/user-manual/userManual.md) - Instrucciones paso a paso para utilizar la plataforma
- 🧰 [Documentación Técnica](./docs/code-docs/technicalInfo.md) - Detalles sobre la implementación y código fuente